...
class Order(models.Model):
    ...
    emailAddress1 = models.EmailField(max_length=250, blank=True, verbose_name="Email address")
    created = models.DateTimeField(auto_now_add=True)
...
class OrderItem(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE)  # Update the field to reference Product model
    quantity = models.IntegerField()
